...
df <- dplyr::count(df_score3, alti500)


ggplot(df_score3 %>% na.omit()) + 
  geom_boxplot(aes(x=factor(alti500),y=valeur, group=alti500, fill=alti500), show.legend = FALSE, 
               alpha=0.5, color="#737373") + # set metric
  geom_label(data = df, mapping=aes(x=alti500, y = 1.1 , label = n))+
...
ggsave(file=file.path("plot", "intcormed_boxalt_i.png"), dpi = 300, width = 8, height = 5)
